...
function init() {
	...
	gui
		.add(params, "baseTilt", -0.3, 0.3, 1e-4)
	...
	gui
		.add(params, "settleIterations", 1, 20, 1)
		.onChange(() => (ikNeedsUpdate = true));
	...
	loader.packages = {
		pi_hexapod_description:
			"https://raw.githubusercontent.com/PI-PhysikInstrumente/PI_ROS_Driver/master/pi_hexapod_driver/pi_hexapod_description/",
	};
	...
	loader
		.loadAsync(
			"https://raw.githubusercontent.com/gkjohnson/PI_ROS_Driver/master/pi_hexapod_driver/pi_hexapod_description/urdf/pi_hexapod.urdf"
		)
		.then((result) => {
			urdfRoot = result;
