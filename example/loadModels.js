...
import { Joint, urdfRobotToIKRoot, setIKFromUrdf } from "../src/index.js";
			...
			(xacro) => {
				...
				urdfLoader.packages = {
					curiosity_mars_rover_description:
						"https://raw.githubusercontent.com/gkjohnson/curiosity_mars_rover-mirror/master/curiosity_mars_rover_description/",
				};
...
export function loadStaubli() {
	return new Promise((resolve, reject) => {
		const url =
			"https://raw.githubusercontent.com/ros-industrial/staubli_experimental/ce422fe0a54232d73cf44e2571fc7abc2f5ff9f6/staubli_tx2_90_support/urdf/tx2_90.xacro";
		const xacroLoader = new XacroLoader();
		xacroLoader.rospackCommands = {
			find(pkg) {
				switch (pkg) {
			...
			(xacro) => {
				...
				urdfLoader.packages = {
					staubli_tx2_90_support:
						"https://raw.githubusercontent.com/ros-industrial/staubli_experimental/ce422fe0a54232d73cf44e2571fc7abc2f5ff9f6/staubli_tx2_90_support/",
				};
				urdf = urdfLoader.parse(xacro);
				ik = urdfRobotToIKRoot(urdf);
...
export function loadATHLETE() {
	return new Promise((resolve, reject) => {
		...
		const url =
			"https://raw.githubusercontent.com/gkjohnson/urdf-loaders/master/urdf/T12/urdf/T12_flipped.URDF";
...
export function loadAthnaut() {
	return new Promise((resolve, reject) => {
		...
		url =
			"https://raw.githubusercontent.com/gkjohnson/nasa-urdf-robots/master/r2_description/robots/r2c5.urdf";
		loader = new URDFLoader(manager);
		loader.packages = {
			r2_description:
				"https://raw.githubusercontent.com/gkjohnson/nasa-urdf-robots/master/r2_description",
